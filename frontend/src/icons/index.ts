...
/*
|--------------------------------------------------------------------------
| أيقونات خارطة الاستثمار
|--------------------------------------------------------------------------
|
| هذه الأيقونات مخصصة للقائمة الجانبية.
| تم تعريفها هنا مباشرة حتى لا نعتمد على أيقونات عامة
| مثل PageIcon للمواقع أو الخريطة.
|
*/

import { ReactComponent as MapIcon } from "./map.svg?react";
